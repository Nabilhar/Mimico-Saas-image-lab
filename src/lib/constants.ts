...
export const NICHE_DATA: Record<string, string[]> = {
    "Health & Wellness": ["Dentist", "Physiotherapist", "Chiropractor", "Optometrist", "Naturopath", "Massage therapist", "Nutritionist / dietitian", "Acupuncturist", "Hearing clinic", "Orthodontist", "Dermatologist"],
    "Home Services": ["Plumber", "Electrician", "HVAC / furnace repair", "Smart home installer", "Roofer", "Landscaper / lawn care", "Pest control", "House cleaner", "Painter", "General contractor", "Window & door installer", "Flooring installer", "Interior designer", "Security systems"],
    ...
    "Professional Services": ["Lawyer / law firm", "Accountant / CPA", "Financial advisor", "Insurance broker", "Mortgage broker", "Immigration consultant", "Business consultant", "Social media agency", "Marketing agency", "HR consultant"],
    "Real Estate & Property": ["Realtor / real estate agent", "Property manager", "Condo management company", "Stager", "Home builder"],
    "Retail": ["Clothing boutique", "Shoe store", "Jewellery store", "Gift shop", "Bookstore", "Toy store", "Sporting goods store", "Specialty grocery", "Supplement / nutrition store", "Electronics store", "Furniture store", "Florist"],
    "Automotive": ["Auto repair shop", "Car detailing", "Tire shop", "Auto body / collision", "Auto parts store"],
    "Education & Childcare": ["Daycare / nursery", "After-school program", "Tutoring centre", "Music school", "Art school / classes", "Language school", "Coding school for kids", "Test prep centre", "Early childhood centre"],
    "Events & Hospitality": ["Event planner", "Venue rental", "Catering (events)", "Hotel / B&B"],
    "Trades & Industrial": ["Welder", "Fabrication shop", "Industrial cleaning", "Pool installation & service", "Irrigation installer"],
    "Pets": ["Veterinarian", "Pet groomer", "Pet boarding / kennel", "Dog trainer"],
    "Technology": ["Web design agency", "App developer", "IT consulting", "Computer repair", "Phone repair shop", "Cybersecurity firm"]
  };
